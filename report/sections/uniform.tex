...
This trend shows the rapid appearance of numerical errors as the mesh size gets smaller, highlighting that one may not refine the whole mesh when not needed.
