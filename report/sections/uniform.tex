...
\newpage
\subsection{Condition Number for the Stiffness Matrix}

We want to investigate here the relation between the mesh size and the stiffness matrix's condtion number, expressed as it follows:
\begin{gather}
