...
\begin{document}
	...
	\begin{abstract}
		\begin{center}
			Report for the course \textit{Metodi Numerici per Equazioni alle Derivate Parziali} on the definition and costruction of an \textit{\reporttitle}\footnote{Written in MATLAB, main functions included under \nameref{source}.}, an approach which consists in considering a sequence of adaptively refined meshes to solve a FEM problem, and its subsequent analysis which includes a comparison against a more naive approach by a sequence of uniformly refined meshes.
		\end{center}
	\end{abstract}
